...
let CharitiesRepository = class CharitiesRepository extends repository_1.DefaultCrudRepository {
    constructor(datasource) {
        super(charity_1.Charity, datasource);
        this.datasource = datasource;
    }
};
CharitiesRepository = __decorate([
    __param(0, core_1.inject('datasources.db')),
    __metadata("design:paramtypes", [loopback_datasource_juggler_1.DataSource])
], CharitiesRepository);
exports.CharitiesRepository = CharitiesRepository;
