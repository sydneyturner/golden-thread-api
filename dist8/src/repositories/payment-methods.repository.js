...
let PaymentMethodsRepository = class PaymentMethodsRepository extends repository_1.DefaultCrudRepository {
    constructor(datasource) {
        super(payment_methods_1.PaymentMethod, datasource);
        this.datasource = datasource;
    }
};
PaymentMethodsRepository = __decorate([
